...
function montarConteudo() {
  ...
  return {
    ...
    // Todos os produtos vão para o site (inclusive os "Disponível = NÃO",
    // que aparecem marcados como "Fora de estoque"). O site decide a exibição.
    produtos: lerTabela(ss.getSheetByName('Produtos')),
